...
const BookingForm = () => {
 ...
 return (
  <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-blue-50 py-10 px-4 sm:px-6 lg:px-8">
    <div className="max-w-6xl mx-auto space-y-10">

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">

        <div className="lg:col-span-7 bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          {listing ? (
            <div>
              ...
              {listing.images.length > 1 && (
                <div className="flex gap-3 mt-4 mb-6 overflow-x-auto pb-2 scrollbar-hide px-4 sm:px-6">
        ...
        <div className="lg:col-span-5">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-xl border border-gray-100 sticky top-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white font-bold py-4 rounded-2xl hover:bg-blue-700 active:scale-[0.98] transition-all shadow-lg shadow-blue-200"
              >
                Book Now
              </button>
